...
//抄的 https://leetcode.com/problems/parse-lisp-expression/discuss/113902/A-Clean-Java-Solution
public class Solution0736 {
	...
	private int eval(String exp, Map<String, Integer> parent) {
		...
		map.putAll(parent);
		List<String> tokens = split(exp.substring(exp.charAt(1) == 'm' ? 6 : 5, exp.length() - 1));
		if (exp.startsWith("(a")) {
